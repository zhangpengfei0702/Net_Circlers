package com.zpf.rxjava.retrofit.network.download;


import com.zpf.rxjava.retrofit.MyApplication;
...
public class DownloadManager {
    ...
    public File saveFile(ResponseBody response, final String destFileName, ProgressListener progressListener) throws IOException {
        ...
        String destFileDir = MyApplication.getInstance().getExternalFilesDir(null) + File.separator;
